...
class ProspectoAdmin(ImportExportModelAdmin):
    ...
    list_editable = ("etapa",)
    change_list_template = "blog/prospecto_changelist.html"
    fieldsets = (
        ("Datos Basicos", {"fields": ("nombre_dueño", "nombre_negocio", "telefono", "correo", "ubicacion")}),
        ("Clasificacion", {"fields": ("etapa", "dolor_principal", "canal_entrada", "que_usa_hoy")}),
